...
if __name__ == "__main__":
    ...
    try:
        ...
        p = Popen('xvfb-run export ORACLE_SID="KDHE_LIMS_CLOUD_PROD" && export ORACLE_HOME="/usr/lib/oracle/21/client64" && export TNS_ADMIN="/usr/lib/oracle/21/client64/network/admin/tnsnames.ora" && /home/ssh_user/miniconda3/bin/activate gen_workflow && /home/ssh_user/miniconda3/envs/gen_workflow/bin/python3.9 /home/ssh_user/Documents/GitHub/CRAB_Analysis/scripts/CRAB_Analysis_Runner.py ' + path_to_data+' '+runDATE, executable="/usr/bin/sh", stdout=PIPE, stderr=STDOUT, shell=True)
        while True:
            line = p.stdout.readline()
            if not line:
                break
