...
def run_create_PDF(samples,run_date, output_pdf_dir ,resource_path,found_genes, mlst_dict,MSA_dir_path ):
    ...
    pdf.create_table(bla_gene_table_data,'',10,0,"C","C",[20,45,35,30,60],"C") 
    pdf.ln(15)
   ...
   #create heat map image
    ...
    pdf.ln(5)
    pdf.create_table(other_genes_table_date,'',10,0,"C","C","uneven","C") 
    pdf.ln(15)
...
def format_table_gene_data(found_genes_dict):
    ...
    for key in [*found_genes_dict] :
        ...
        if re.search("bla",key) :
            ...
            temp_gene = found_genes_dict[key][1]+" (variant of "+found_genes_dict[key][6].split(" ")[0]+")"
